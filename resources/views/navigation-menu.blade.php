<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="/video" :active="request()->routeIs('video.index')">
                        {{ __('Videos') }}
                    </x-nav-link>

                    <x-nav-link href="/blog" :active="request()->routeIs('bolg.index')">
                        {{ __('Articles') }}
                    </x-nav-link>


                    @guest()
                        <x-nav-link href="/register" :active="request()->routeIs('login')">
                            {{ __('Join') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="/video" :active="request()->routeIs('video')">
                {{ __('Videos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/video" :active="request()->routeIs('blog.index')">
                {{ __('Articles') }}
            </x-responsive-nav-link>
        </div>
          @auth()
